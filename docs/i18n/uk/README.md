...
> 📢 **Community-Driven Fork**: Це незалежно підтримувана, керована спільнотою версія NOFX. Ми зосереджуємося на стабільності, користувацькому досвіді та потребах спільноти.
>
> **Оригінальний проект**: [nofxaios/nofx](https://github.com/nofxaios/nofx)
...
**🎁 [Зареєструватися на Binance - Отримати знижку](https://www.binance.com/join?ref=SA020XCM)**
...
1. **Відвідайте Hyperliquid за реферальним посиланням** (отримайте переваги!):
   ...
   **🎁 [Зареєструватися на Hyperliquid - Приєднатися до AITRADING](https://app.hyperliquid.xyz/join/NOFXAI)**
